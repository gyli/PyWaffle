...
* Refuse to draw a chart of more than `MAX_BLOCKS` (1,000,000) blocks. Values that were meant to be scaled previously turned into minutes of drawing rather than an error; the limit can be raised with `pywaffle.waffle.MAX_BLOCKS`
